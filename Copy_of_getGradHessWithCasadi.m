...
contact     = SX.sym('contact'    , delcontact_length * H, 1);
delcontact  = SX.sym('delcontact' , delcontact_length * H, 1);
contact_ref = SX.sym('contact_ref', delcontact_length * H, 1);

v = [X; U; delcontact];

W_Q = SX.sym('W_Q', H * state_length, 1);
W_R = SX.sym('W_R', H * input_length, 1);
W_C = SX.sym('W_C', H * delcontact_length, 1);

J = (X - X_ref)' * diag(W_Q) * (X - X_ref) + (U - U_ref)' * diag(W_R) * (U - U_ref) + (contact + delcontact - contact_ref)' * diag(W_C) * (contact + delcontact - contact_ref);
...
for i = 1:H
    ...
    delcontact_k  = delcontact((delcontact_length  * (i-1) + 1):(delcontact_length  * i));
    ...
    Ac = SX.zeros(state_length, delcontact_length);
    ...
    k1 = A *  x_k + B * u_k + d + Ac * delcontact_k;
    k2 = A * (x_k + 0.5 * dT * k1) + B * u_k + d + Ac * delcontact_k;
    k3 = A * (x_k + 0.5 * dT * k2) + B * u_k + d + Ac * delcontact_k;
    k4 = A * (x_k + dT * k3) + B * u_k + d + Ac * delcontact_k;
...
cineq6_max = []; cineq6_min = [];
cineq7_max = []; cineq7_min = [];

delcontact_x_max = SX.sym('delcontact_x_max');
delcontact_x_min = SX.sym('delcontact_x_min');
delcontact_y_max = SX.sym('delcontact_y_max');
delcontact_y_min = SX.sym('delcontact_y_min');

for i = 1:H
    delcontact_x = delcontact(delcontact_length * (i-1) + 1);
    delcontact_y = delcontact(delcontact_length * (i-1) + 2);
    delcontact_z = delcontact(delcontact_length * (i-1) + 3);
...
cineq7_max_v = jacobian(cineq7_max, v);
cineq7_min_v = jacobian(cineq7_min, v);
...
cineq6_max_func = Function('cineq6_max_func', {delcontact, delcontact_x_max}, {cineq6_max});
cineq6_min_func = Function('cineq6_min_func', {delcontact, delcontact_x_min}, {cineq6_min});
cineq7_max_func = Function('cineq7_max_func', {delcontact, delcontact_y_max}, {cineq7_max});
cineq7_min_func = Function('cineq7_min_func', {delcontact, delcontact_y_min}, {cineq7_min});
...
cineq6_max_v_func = Function('cineq6_max_v_func', {delcontact, delcontact_x_max}, {cineq6_max_v});
cineq6_min_v_func = Function('cineq6_min_v_func', {delcontact, delcontact_x_min}, {cineq6_min_v});
cineq7_max_v_func = Function('cineq7_max_v_func', {delcontact, delcontact_y_max}, {cineq7_max_v});
cineq7_min_v_func = Function('cineq7_min_v_func', {delcontact, delcontact_y_min}, {cineq7_min_v});
...
cineq7_max_func.generate('cineq7_max_func.c', opts);
mex cineq7_max_func.c
cineq7_min_func.generate('cineq7_min_func.c', opts);
mex cineq7_min_func.c
...
cineq7_max_v_func.generate('cineq7_max_v_func.c', opts);
mex cineq7_max_v_func.c
cineq7_min_v_func.generate('cineq7_min_v_func.c', opts);
mex cineq7_min_v_func.c
