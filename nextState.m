function [mL, fL, mR, fR, delcontact] = nextState(x0, ...
...
[P, c, A, b, G, h] = qpswiftParameters(x0, theta_ref_horizon, COM_ref_horizon, w_ref_horizon, dCOM_ref_horizon, contact_ref_horizon, ...
                                       contact, contact_ref, ...
                                       rL_ref_horizon, rR_ref_horizon, fL_ref_horizon, fR_ref_horizon, etaL_ref_horizon, etaR_ref_horizon, etak_ref_horizon);
...
delcontact = v(PARA.H*(PARA.state_length + PARA.input_length) + 1: PARA.H*(PARA.state_length + PARA.input_length) + 3);
