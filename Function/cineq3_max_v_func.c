...
void mex_cineq3_max_v_func(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  --resc;
  res[0] = w+181;
  cineq3_max_v_func_incref();
  mem = cineq3_max_v_func_checkout();
  i = cineq3_max_v_func(arg, res, iw, w+241, mem);
  if (i) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"cineq3_max_v_func\" failed.");
  cineq3_max_v_func_release(mem);
  cineq3_max_v_func_decref();
