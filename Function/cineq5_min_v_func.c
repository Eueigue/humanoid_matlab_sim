...
void mex_cineq5_min_v_func(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  --resc;
  res[0] = w+181;
  cineq5_min_v_func_incref();
  mem = cineq5_min_v_func_checkout();
  i = cineq5_min_v_func(arg, res, iw, w+241, mem);
  if (i) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"cineq5_min_v_func\" failed.");
  cineq5_min_v_func_release(mem);
  cineq5_min_v_func_decref();
